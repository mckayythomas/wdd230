const apiURL = "https://api.openweathermap.org/data/2.5/weather?lat=42.6544&lon=111.6047&appid=c78aa2048fa7d286e4c1c542c60adca2&units=imperial"
...
const forcastURL = "http://api.openweathermap.org/data/2.5/forecast?lat=42.6544&lon=111.6047&cnt=40&appid=c78aa2048fa7d286e4c1c542c60adca2&units=imperial"
fetch(forcastURL)
    .then((response) => response.json())
    .then((jsObject) => {
        //console.log(jsObject);
